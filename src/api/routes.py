...
from ..services.segment_crud_service import SegmentCrudService
from ..services.segment_search_service import SegmentSearchService
from ..services.segment_bulk_service import SegmentBulkService
...
async def search_segments(
    ...
    return await SegmentSearchService.search_segments(q, site, allocated)
...
async def update_segment(segment_id: str, segment: Segment, background_tasks: BackgroundTasks):
    """Update a segment"""
    return await SegmentCrudService.update_segment(segment_id, segment, background_tasks)
